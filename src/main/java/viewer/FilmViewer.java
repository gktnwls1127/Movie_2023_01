...
public class FilmViewer {
    ...
    private void delete(int id){
        String message = "해당 영화를 정말 삭제 하시겠습니까? Y/N";
        String yesNo = ScannerUtil.nextLine(SCANNER, message);
        if (yesNo.equalsIgnoreCase("Y")){
            onBoardViewer.deleteFilmId(id);
    ...
    public void printFilmTitle(int id){
        System.out.print(filmController.selectFilmTitle(id));
    }

    public boolean validateMovieId(int movieId) {
        return filmController.validateFilmId(movieId);
    }
}
